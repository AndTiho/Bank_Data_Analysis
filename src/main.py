...
from utils import greetings, excel_to_df, PATH_TO_EXCEL, group_by
import time
...
def main():
    ...
    print(greetings())
    print('Мы рады представить вам программу для работы с excel данными\n'
    ...
    if user_input == '1':
        ...
        time.sleep(1)
        print('К сожалению в данный момент, для корректной работы необходимо выбрать дату'
    ...
    # Здесь отрабатываем функционал модуля services.py
        ...
        print(f'Вы выбрали пункт номер: {user_input}.')
        time.sleep(1)
        print('Чтобы определить наиболее выгодные категории Кэшбэка, необходимо указать '
        ...
        while True:
            ...
            try:
                ...
                # Если возникла ошибка - просим ввести заново
                print('Неверный формат даты!')
                print('ПОЖАЛУЙСТА!!!!! введите дату в формате YYYY-MM'
    ...
    # Тут работаем с функционалом из reports.py
        ...
        print(f'Вы выбрали пункт номер: {user_input}.')
        time.sleep(1)
        print('Что бы получить отчёт по тратам за последние три месяца по интересующей'
              'вас категории, вам для начала необходимо выбрать "Категорию".')
        time.sleep(1)
        print('Для корректной работы программы, просим вас выбрать категорию из тех,'
        ...
        while True:
            ...
            try:
                ...
                # Если возникла ошибка - просим ввести заново
                print('Неверный формат даты!')
                print('ПОЖАЛУЙСТА!!!!! введите дату в формате YYYY-MM-DD'
                      ' или введите exit для выхода')
    ...
    #Здесь отрабатывается вариант exit -> выход из программы
        ...
        time.sleep(1)
        print(f'Мы чувствуем, что вы выбрали пункт 4...')
        time.sleep(1)
        print('Ну что ж...спасибо, что выбрали Bank_AD.')
        time.sleep(1)
